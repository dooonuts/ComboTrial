...
UINT8_T SERSendStr(const rom far char  *Str);  ///< Outputs a string on the serial line
...
void RxClear(void);                         ///< resets rx buffer, rxhead = rxtail
void TxClear(void);                         ///< resets tx buffer, txhead = txtail
void AllClear(void);                        ///< clears rx and tx buffers
UINT8_T SERSendData(char Str[32]);          ///< built for data from a char array       
